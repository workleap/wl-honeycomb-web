...
import { normalizeUrl } from "../src/normalizeUrl.ts";

test.concurrent("case 1", ({ expect }) => {
    const result = normalizeUrl("https://api.performance.workleap.com/app/getManagerReview?reviewCycleId=681bde2d32652ec23d59ea24&revieweeId=186bc69e-9545-4713-96f2-d9d4ca848ab1");
...
test.concurrent("case 2", ({ expect }) => {
    const result = normalizeUrl("https://api.officevibe.workleap.com/custompolls/api/custom-polls/templates/officevibe/recurrent?templateIds=68472b1d537193e7b394ac08&templateIds=60da073879acd1558cf0fb0d");
...
test.concurrent("case 4", ({ expect }) => {
    const result = normalizeUrl("https://api.officevibe.workleap.com/engagement/api/pulse-survey/summary/beba4f37-9ceb-456d-815e-978d98136523?timePeriod=30&startDate=null&endDate=null");
...
test.concurrent("case 5", ({ expect }) => {
    const result = normalizeUrl("https://api.officevibe.workleap.com/engagement/api/pulse-survey/summary/00000000-0000-0000-0000-000000000000?timePeriod=30&startDate=null&endDate=null");
